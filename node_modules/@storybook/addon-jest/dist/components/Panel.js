...
(0, _styled.default)(function (_ref2) {
  ...
  }, "".concat(successNumber / result.assertionResults.length * 100, "%")));
}, {
  target: "e1chx92q6"
})(function () {
  return {
...
(0, _styled.default)(function (_ref3) {
  ...
  return _react.default.createElement("div", {
    ...
    return _react.default.createElement("section", {
      key: name
    }, _react.default.createElement(SuiteHead, null, _react.default.createElement(SuiteTitle, null, _react.default.createElement(_Indicator.default, {
      color: result.status === 'passed' ? _colors.default.success : _colors.default.error,
      size: 16,
      styles: {
        marginRight: 5
      }
    }, result.status), _react.default.createElement(FileTitle, null, name)), _react.default.createElement(SuiteTotals, {
      successNumber: successNumber,
      failedNumber: failedNumber,
      result: result
    }), _react.default.createElement(SuiteProgress, {
      successNumber: successNumber,
      failedNumber: failedNumber,
      result: result
...
var Panel = function Panel(_ref6) {
  ...
  return tests ? _react.default.createElement(Content, {
    tests: tests
  }) : _react.default.createElement(NoTests, null, "This story has no tests configures");
};
...
Panel.propTypes = {
  tests: _propTypes.default.arrayOf(_propTypes.default.shape({
