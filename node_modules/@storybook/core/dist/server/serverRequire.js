...
var _interpretFiles = require("./config/interpret-files");
...
function serverRequire(filePath) {
  ...
  var candidatePath = existingCandidate.path,
      candidateExt = existingCandidate.ext;
  ...
  if (moduleDescriptor && registerCompiler(moduleDescriptor) === 0) {
    _nodeLogger.logger.warn("=> File ".concat(candidatePath, " is detected"));

    _nodeLogger.logger.warn("   but impossible to import loader for ".concat(candidateExt));
