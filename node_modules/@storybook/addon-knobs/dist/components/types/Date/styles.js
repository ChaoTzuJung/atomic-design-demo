...
var _default = function _default(_ref) {
  var theme = _ref.theme,
      size = _ref.size;
  return (0, _objectSpread2.default)({}, _components.Input.sizes({
    size: size,
    theme: theme
  }), {
    '&.rdt': {
    ...
    '& > input': (0, _objectSpread2.default)({
      width: '100%',
      height: 32
    }, _components.Input.styles({
      theme: theme
    }), _components.Input.alignment({
      theme: theme
    })),
    '& .rdtPicker': {
      display: 'none',
    ...
    '& .rdtPicker td.rdtToday:before': {
      ...
      borderBottom: "7px solid ".concat(theme.highlightColor),
    ...
    '& .rdtPicker td.rdtActive, & .rdtPicker td.rdtActive:hover': {
      ...
      color: '#fff',
      textShadow: '0 -1px 0 rgba(0,0,0,0.25), 0 1px 0 rgba(0,0,0,0.25), -1px 0 0 rgba(0,0,0,0.25), 1px 0 0 rgba(0,0,0,0.25)'
    },
    ...
    '& .rdtPicker th': {
      borderBottom: "1px solid ".concat(theme.highlightColor)
    },
    '& .rdtPicker .dow': {
      width: '14.2857%',
      fontSize: 11,
